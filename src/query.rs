...
impl<'r> Row<'r> {
    ...
    pub fn as_array(&self) -> Array {
        unsafe { Array{_ref: CBLResultSet_ResultArray(self.results._ref), _owner: PhantomData} }
    }

    /** Returns all of the columns as a Fleece dictionary. */
    pub fn as_dict(&self) -> Dict {
        unsafe { Dict{_ref: CBLResultSet_ResultDict(self.results._ref), _owner: PhantomData} }
    }
}
